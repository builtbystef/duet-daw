...
/** The Settings window: everything app-global the producer sets once.
    ...
    It opens with one tab, Interface — theme, interface scale, and the rendering
    escape hatch — and later slices add their own beside it. Every row is in
    force where it stands and stored for the next launch.
*/
